...
- 🧩 Паттерны проектирования для JavaScript и TypeScript: Шемсединов Тимур, Илья Климов, Дмитрий Нечай - 2025-03-22
- [Local-first подход, CRDT и фронтенд — синхронизация в распределенных системах](https://youtu.be/XNUNxghX9dg)
- [🧩 JavaScript и TypeScript Patterns Q&A Call #13: Литература, курс, DDD, моделирование, софтскилы](https://youtu.be/4jcB_G_u8BY)
