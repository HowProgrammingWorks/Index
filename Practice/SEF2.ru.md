...
по 2-5 человек; группа может писать один общий проект или делать перекретсный
...
улучшение кодовой базы, рефакторинг и опритизацию. Пересмотрите:
...
- Репозиторий должен включать:
  ...
  - Файл `README.md` с кратким (1-2 страницы) описанием проекта. Ни какие папки
...
- Библиотека для работы с IPv4 и IPv6 адерсами: парсер, сравнение, манипуляции,
...
кадый второй понедельник месяца в 12:30 по UTC. Он создает необходимые для этого
